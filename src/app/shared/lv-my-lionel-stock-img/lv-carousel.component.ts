...
import { LvSlideComponent } from './lv-slide.component';
...
export class LvCarouselComponent implements OnDestroy {
  ...
  private slides:Array<LvSlideComponent> = [];
  private currentInterval:any;
  private isPlaying:boolean;
  private destroyed:boolean = false;
  private currentSlide:LvSlideComponent;
  ...
  public select(nextSlide:LvSlideComponent, direction:Direction = Direction.UNKNOWN):void {
  ...
  public next():any {
    ...
    if( newIndex === 0 ){
        this.onBeginWrap.emit(newIndex);    
    };
  ...
  public addSlide(slide:LvSlideComponent):void {
  ...
  public removeSlide(slide:LvSlideComponent):void {
  ...
  private goNext(slide:LvSlideComponent, direction:Direction):void {
    if (this.destroyed) {
      return;
    }
...
export const LV_CAROUSEL_DIRECTIVES:Array<any> = [LvCarouselComponent, LvSlideComponent];